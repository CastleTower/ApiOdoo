...
using ComunicactionComponents.Interface;
...
namespace ComunicactionComponents.Model
{
    public class RpcConnection
    {
        ...
        private IObjectRpccs _objectRpc;
        private readonly RpcConnectionSettings _rpcConnectionSetting;

        public RpcConnection() { }

        public RpcConnection(RpcConnectionSettings rpcConnectionSettings)
        {
            _rpcConnectionSetting = rpcConnectionSettings;
            _rpcConnectionSchema = new RpcConnectionSchema(rpcConnectionSettings.ServerUrl, rpcConnectionSettings.DbName, rpcConnectionSettings.DbUser, rpcConnectionSettings.DbPassword);
        ...
        public bool Login()
        {
            try
            {
                ...
                _objectRpc = XmlRpcProxyGen.Create<IObjectRpccs>();
        ...
        {
            return _objectRpc.create(_rpcConnectionSchema.DbUser, _rpcConnectionSchema.UserId, _rpcConnectionSchema.DbPassword, model, "create", fieldValues);
        }
